...
const PASSWORD_VALIDATION_MSG = 'Password must contain as many as 8 characters including lower-case, upper-case, numeric characters and at least one special character: +-_@$!%*?&#.,;:[]{}';
