      ...
      `<div class="body__game-sprint body__game-sprint--background">
        <div class="wrapper wrapper__sprint-game">
          <div class="inner__game-sprint">
            ...
            <div class="game-sprint__rating">
              <img src="https://img.icons8.com/nolan/50/goal.png"/>
              <img src="https://img.icons8.com/nolan/50/goal.png"/>
              <img src="https://img.icons8.com/nolan/50/goal.png"/>
              <img src="https://img.icons8.com/nolan/50/goal.png"/>
            </div>
            <div class="game-sprint__field">
              <div class="game-sprint__word game-sprint__word--eng">eng word</div>
              <div class="game-sprint__word game-sprint__word--rus">rus word</div>
