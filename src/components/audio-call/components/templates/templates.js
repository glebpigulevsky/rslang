...
<div class="start-game">
<button class="main-button__start start with-select">START</button>
<button class="main-button__start start learn-my-words">LEARN MY WORDS</button>
</div>
...
export {
  statsTemplate, gameTemplate, roundCalc, startScreenTemplate,
};
