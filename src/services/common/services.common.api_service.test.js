...
describe('get request any site with token', () => {
  it('should return correct response', async () => {
    const res = await service.getResource({ url: '/get/json', hasToken: true, token });
...
describe('get request any site', () => {
  it('should return error', async () => {
    try {
      await service.getResource({ url: '/get/error', hasToken: true, token });
    } catch (e) {
...
describe('post request any site', () => {
  it('should return error', async () => {
    try {
      await service.postResourse({ url: '/post/error', hasToken: true, token });
    } catch (e) {
      expect(e.message).toEqual(ERRORS_DESCRIPTION[404]);
    }
  });
...
describe('put request any site', () => {
  it('should return error', async () => {
    try {
      await service.putResourse({ url: '/put/error', hasToken: true, token });
    } catch (e) {
      expect(e.message).toEqual(ERRORS_DESCRIPTION[404]);
    }
  });
...
describe('delete request any site with token', () => {
  it('should return correct response', async () => {
    const res = await service.deleteResourse({ url: '/delete/json', hasToken: true, token });
    expect(res).toBeDefined();
...
describe('delete request any site', () => {
  it('should return error', async () => {
    try {
      await service.deleteResourse({ url: '/delete/error', hasToken: true, token });
    } catch (e) {
      expect(e.message).toEqual(ERRORS_DESCRIPTION[404]);
    }
  });
